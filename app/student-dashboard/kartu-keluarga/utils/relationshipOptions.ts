...
export const KK_RELATIONSHIP_OPTIONS: RelationshipOption[] = [
  ...
  { id: 'KAKAK LAKI-LAKI', labelId: 'Kakak Laki-laki', jp: '兄' },
  { id: 'KAKAK PEREMPUAN', labelId: 'Kakak Perempuan', jp: '姉' },
  { id: 'ADIK LAKI-LAKI', labelId: 'Adik Laki-laki', jp: '弟' },
  { id: 'ADIK PEREMPUAN', labelId: 'Adik Perempuan', jp: '妹' },
