...
import { getAuthUserId, getAuthUserName, saveAuthSession } from '@/lib/auth';
...
export default function AdminChangePasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Pakai token baru dari login verifikasi (token lama di localStorage bisa sudah kedaluwarsa → 401).
      ...
      const updateRes = await ApiUser().putUpdateUserPassword({
        id_user: idUser,
        ...
        <header className="flex items-start gap-4 mb-10 pb-8 border-b border-gray-200/50">
          ...
          <div>
            ...
            <p className="text-sm font-light text-gray-500 mt-2 tracking-wide">
              Perbarui kredensial akun administrator Anda.
            </p>
          </div>
        </header>
