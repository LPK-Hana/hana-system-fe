...
export default function DeleteJobModal({ onClose, onConfirm, isSubmitting = false }: DeleteJobModalProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      ...
      <div className="relative z-10 w-full max-w-sm bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        <div className="px-6 pb-6 pt-2 text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">Hapus Job</h3>
          <p className="text-sm text-gray-500 mb-6">
            Apakah Anda yakin ingin menghapus job ini? Semua siswa yang di-assign akan otomatis di-unassign. Tindakan ini tidak dapat dibatalkan.
          </p>
