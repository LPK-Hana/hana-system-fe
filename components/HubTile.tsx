...
export const hubTileClassName =
  'group relative overflow-hidden bg-white border border-raftel-200 py-4 px-3 flex flex-col items-center justify-center gap-1.5 no-underline transition-colors duration-300 hover:border-raftel-400 hover:bg-raftel-50/30';
...
export function HubTileLink({ href, label, sub, icon }: HubTileLinkProps) {
  return (
    <Link href={href} className={hubTileClassName}>
      <span className="text-raftel-800">{icon}</span>
